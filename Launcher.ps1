...
do {
    ...
    Write-Host "3. Allapot lekerdezese"
    Write-Host "4. Toredezettseg mentesites inditasa (Defrager.ps1)"
    Write-Host "5. Lemezellenorzes (Scandiser.ps1)"
    Write-Host "6. Korkoros karbantartas - Erosen toredezett, hasznalt meghajtok eseten!"
